...
/**
 * Validate is actual value is not in range
 */
public class NotInRangeValidator implements Validator {
    private final Logger LOGGER = LoggerFactory.getLogger(this.getClass().getName());

    private Range range;
    private ErrorRepresentation errorRepresentation;

    public NotInRangeValidator(final Range range, final ErrorRepresentation errorRepresentation) {
        this.range = range;
